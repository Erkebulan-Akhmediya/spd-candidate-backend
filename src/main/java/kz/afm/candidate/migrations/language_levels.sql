insert into reference.language_level (code, name_rus, name_kaz)
values ('A1', 'Beginner + Elementary (Начальный)', 'Beginner + Elementary (Бастапқы)'),
       ('A2', 'Pre-Intermediate (Ниже среднего)', 'Pre-Intermediate (Ортадан кем)'),
